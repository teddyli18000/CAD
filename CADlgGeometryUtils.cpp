...
// return: 从from到to的逆时针角距离，范围为[0,2π);
...
// return: true:折线与圆形区域相交或落入圆内; 
// false:折线与圆形区域无交集;

}
} // namespace cad::dlg::xxx
